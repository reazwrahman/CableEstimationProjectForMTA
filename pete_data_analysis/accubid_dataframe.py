...
#            drawings_database.append(total[i].drawing.strip(' '))  
    ...
    #### create an artificial drawings database with all possible drawing numbers ### 
    a='L-' 
    b='TE-' 
    c='FOC-' 
    drawings_database=[] 
    for i in range (100,800,100): 
        for j in range (0,51,1): 
            adder=str(i+j)
            drawings_database.append(a+adder) 
            drawings_database.append(b+adder) 
            drawings_database.append(c+adder)
